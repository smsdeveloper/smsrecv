...
public class NingBoDxServiceImpl extends BaseService implements IBaseService{
	
	private static final Logger log = Logger.getLogger(NingBoDxServiceImpl.class);
